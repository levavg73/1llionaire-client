        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent>
              ...
              {f.available_regions.length > 0 && (
                <>
                  <Separator className="my-3" />
                  <div className="flex items-start gap-2 text-sm">
                    <MapPin className="mt-0.5 h-3.5 w-3.5 text-muted-foreground" />
                    <div>
                      <p className="font-medium">진행 가능 지역</p>
                      <p className="text-muted-foreground">{f.available_regions.join(", ")}</p>
                    </div>
                  </div>
                </>
              )}
              {f.languages.length > 0 && (
                <>
                  ...
                  <div className="flex items-start gap-2 text-sm">
                    ...
                    <div>
                      <p className="font-medium">가능 언어</p>
                      <p className="text-muted-foreground">{f.languages.join(", ")}</p>
                    </div>
                  </div>
                </>
              )}
